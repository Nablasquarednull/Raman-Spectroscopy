...
\begin{table}[htbp]
    \centering
    \caption{Observed Raman bands of carbon tetrachloride ($\mathrm{CCl_4}$) according to NIST. The experimental values will be added after analysis of the measured spectrum.}
...
\begin{table}[htbp]
    \centering
    \caption{Observed Raman bands of benzene ($\mathrm{C_6H_6}$) according to NIST. The experimental values will be added after analysis of the measured spectrum.}
